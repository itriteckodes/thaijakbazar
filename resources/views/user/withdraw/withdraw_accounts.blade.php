                    ...
                    <form action="{{route('user.withdraw-account.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 txt4">
                                ...
                                <input name="title" type="text" class="form-control txt4" placeholder="{{__('Enter full name')}}" value="{{ Auth::user()->name }}" readonly>
                            </div>
                            ...
                            <div class="form-group col-md-6 txt4">
                                ...
                                <select id="select"  name="withdrawmethod_id" class="form-control txt4" placeholder="Enter Amount" required>
                                    @foreach (App\Models\WithdrawMethod::all() as $method)
