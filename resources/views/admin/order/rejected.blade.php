        ...
        <table class="table datatable-save-state table-responsive">
            ...
            <tbody>
                ...
                <tr class="txt4">
                        ...
                        <div class="list-icons">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">             
                                    <a href="{{route('admin.order.status.accept',$order->id)}}" class="edit-btn dropdown-item edit-btn txt4">
                                    <i class="icon-book"></i> accepted</a>
                                    <a href="{{route('admin.order.readyToShip',$order->id)}}"
                                        class="edit-btn dropdown-item edit-btn txt4">
                                        <i class="icon-pencil"></i> Ready To Ship</a>
                                    <a href="{{route('admin.order.status.deliver',$order->id)}}" class="edit-btn dropdown-item edit-btn txt4">
                                    <i class="icon-stack"></i> delivered</a>
                                    
                                    <a href="{{route('admin.order.status.dispatch',$order->id)}}" class="edit-btn dropdown-item edit-btn txt4">
                                    <i class="icon-pencil"></i> dispatched</a>
                                </div>
                            </div>
                        </div>  
                    </td>
                    ...
                    <td><a href="{{route('admin.order.details',$order->id)}}" class="btn btn-primary">View</a></td>
