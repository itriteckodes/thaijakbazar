        ...
        <table class="table datatable-basic table-responsive">
            ...
            <tbody >
                ...
                <tr class="txt4">
                    ...
                    <td>
                        <button data-toggle="modal" data-target="#edit_modal" id="{{$order->id}}" class="edit-btn btn btn-secondary txt4">Comments</button>
                    </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input class="form-control txt4" type="text" name="comment" placeholder="Comment" required>
                    </div>
                </div>
