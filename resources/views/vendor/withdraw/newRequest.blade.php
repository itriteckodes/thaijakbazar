...
@if (Auth::user()->CanWithdrawAccount->count() == 0)
    <div class="alert alert-primary border-0 alert-dismissible">
        ...
        <span class="font-weight-semibold txt4">{{__('Please Approve Your Withdraw Account to Make Withdraw Request.')}}</span>
    </div>
@endif
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="formloader" action="{{route('vendor.withdraw.createRequest')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 txt4">
                                ...
                                <input name="amount" type="number" min="1"  max="{{ Auth::user()->account == null ? '0': Auth::user()->account->balance }}" class="form-control txt4" placeholder="Enter Withdraw Amount" required>
                            </div>
                            <div class="form-group col-md-6 txt4">
                                <label>{{__('Select Withdraw Account')}}</label>
                                <select  name="withdrawaccount_id" class="form-control txt4" placeholder="Enter Amount" required>
                            ...
                            <div class="text-right col-md-12 txt4">
