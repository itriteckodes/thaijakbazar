            ...
            <div class="col-md-12">
                <div class="breadcrumb-box text-center">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="list-inline-item"><span>||</span>{{__(' Vendor Register')}}</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('vendor_register')}}" method="POST">
                    @csrf
                    <h5>{{__('Create Vendor Account')}}</h5>
                    <div class="row">
                        <div class="col-md-12">
                            <label>{{__('Name')}}*</label>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="shop_name" placeholder="{{__('Your Shop Name')}}" value="{{old("shop_name")}}" required>
                        </div>
